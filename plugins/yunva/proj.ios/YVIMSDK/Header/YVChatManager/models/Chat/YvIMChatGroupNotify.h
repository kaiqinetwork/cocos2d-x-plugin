...
@interface YvIMChatGroupNotify : YvBackBase

@property(assign, nonatomic) UInt32     groupid;//群ID
@property(assign, nonatomic) UInt32     sendid;//发送者ID
@property(assign, nonatomic) UInt32     time;//发送时间
@property(strong, nonatomic) NSString * groupicon;//群头像地址
@property(strong, nonatomic) NSString * groupname;//群名称
@property(assign, nonatomic) UInt8      type;//消息类型 e_chat_msgtype
@property(strong, nonatomic) NSString * data;//若为文本类型，则是消息内容，若为音频，则是文件地址，若为图像，则是大图像地址
