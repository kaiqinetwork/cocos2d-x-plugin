...
public class UserAdapter implements InterfaceUser {
	private static final String LOG_TAG = "huawei.UserAdapter";
	...
	public void switchAccountBefore(){
		actionResult(UserWrapper.ACTION_RET_LOGOUT_SUCCESS, "switch success");
	}
